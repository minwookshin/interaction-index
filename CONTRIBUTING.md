...
Interaction Index is an MIT-licensed alpha. This guide defines the quality bar for changes before the canonical public repository begins accepting outside contributions.
...
The project does not yet have a canonical public repository or issue tracker. Until those exist, this file is the review contract rather than an invitation to send patches. Contributors must also follow `CODE_OF_CONDUCT.md`; vulnerabilities use the private process in `SECURITY.md`.
