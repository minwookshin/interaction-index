...
await copyFile(resolve(root, "src/whatiuse.css"), resolve(packageRoot, "styles.css"));
await copyFile(resolve(root, "src/tokens/generated.css"), resolve(packageRoot, "tokens.css"));
await copyFile(resolve(root, "src/whatiuse-tailwind.css"), resolve(packageRoot, "tailwind.css"));
