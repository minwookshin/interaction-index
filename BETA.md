...
Teum is preparing a public beta around the pinned `0.1.0-rc.22` registry. The beta is for real product evaluation, not a production-readiness claim.
...
Use the repository's **Adopter feedback** issue form. Include the exact version, integration path, product task, environment, build result, and whether the component stayed in the project. Do not include confidential product data or vulnerability details.
