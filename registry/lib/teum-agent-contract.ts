...
export const teumAgentRecipeContracts = [
  ...
  },
  {
    ...
    title: "Product Usage",
    domain: "analytics",
    intent: "Connect active usage, feature adoption, and release events across synchronized views.",
    ...
    state: ["shared active index", "visible series", "selected release"],
    rules: ["Synchronize charts through one active index.", "Keep date order stable when series are filtered.", "Map each release to one stable annotation."],
    forbidden: ["Do not give synchronized charts separate pointer state.", "Do not remove textual values when a series is hidden.", "Do not animate high-frequency inspection."],
  },
  {
