...
export function CollapsibleTrigger({ className, children, ...props }: CollapsiblePrimitive.Trigger.Props) {
  return (
    <CollapsiblePrimitive.Trigger className={cn("whatiuse-collapsible__trigger", className)} {...props}>
      <span>{children}</span>
...
export function CollapsibleContent({ className, children, ...props }: CollapsibleContentProps) {
  return (
    <CollapsiblePrimitive.Panel className={cn("whatiuse-collapsible__panel", className)} {...props}>
      <div className="whatiuse-collapsible__content">{children}</div>
